...
impl PaymentService for MyPaymentService {
    async fn process_payment(
        ...
        // This example immediately returns a successful return for demonstration purposes
        ...
        tokio::spawn(async move {
            while let Some(message) = stream.message().await.unwrap_or_else(|_| None) {
                ...
                let reply = ChatMessage {
                    ...
                    message: format!("Terima kasih telah melakukan chat kepada CS virtual, Pesan anda akan dibalas pada jam kerja."),
                };
